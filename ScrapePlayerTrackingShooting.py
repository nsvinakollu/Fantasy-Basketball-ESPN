...
def getStuff():
    ...
    url = 'https://www.nba.com/stats/players/shooting-efficiency/?Season=2019-20&SeasonType=Regular%20Season'
    browser.get(url)
    # =============================================================================
    ...
    #browser.find_element_by_xpath('/html/body/div[5]/div[3]/div/div/div[2]/div/div/button').click()                                       
    
    table = browser.find_element_by_xpath('/html/body/main/div/div/div[2]/div/div/nba-stat-table/div[2]/div[1]/div/table')

    team_names = []
    team_stats = []
    
    pages = Select(browser.find_element_by_xpath('/html/body/main/div/div/div[2]/div/div/nba-stat-table/div[3]/div/div/select'))  
